...
|---|---|---|---|---|---|
| `tools/sponsors/index.html` | `/Users/lun04/Desktop/Sponsors Logo HTML Creator` | `SEMITWmkt/Sponsors-Logo-HTML-Creator` | `main @ 72d03a6` | Integrated v5.1.1 + data resilience + project state slice | Adds batch sponsor metadata paste, missing-logo work items, URL normalization, output protection, project name, work file save/load, visible autosaved draft state, and inline name/tier edits. Source repo still needs sync after Hub validation. |
