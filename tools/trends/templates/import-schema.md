...
Legacy single-link columns such as `對應專區連結`, `對應論壇連結`, `ZoneN URL`, or `ForumN URL` are still accepted. When only one URL is supplied, the importer uses it for both Chinese and English output.
...
```text
1	AI算力	AI Computing	算力需求迎來指數型爆發...		AI半導體・ASIC・熱管理	AI Semiconductor・ASIC・Thermal	AI半導體技術特區	AI Semiconductor Technology Zone	https://example.com/zh/zone	https://example.com/en/zone	大師論壇	CEO Summit	https://example.com/zh/forum	https://example.com/en/forum
1	AI算力					半導體封裝專區	Semiconductor Packaging Zone	https://example.com/zh/zone-2	https://example.com/en/zone-2	半導體先進製程科技論壇	Advanced Process Forum	https://example.com/zh/forum-2	https://example.com/en/forum-2
```
